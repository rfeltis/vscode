...
import { CHAT_CATEGORY, CHAT_OPEN_ACTION_ID } from '../actions/chatActions.js';
...
class ChatModelPickerTourContribution extends Disposable implements IWorkbenchContribution {
	...
	arm(): void {
		...
		this._badge.value = this.activityService.showViewContainerActivity(ChatViewContainerId, {
			badge: new NumberBadge(1, () => localize('chat.onboarding.modelPicker.badge', "New: your favorite model is available in chat")),
		});
