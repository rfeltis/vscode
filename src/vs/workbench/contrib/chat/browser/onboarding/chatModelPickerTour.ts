	...
	steps: [
		{
			...
			title: localize('chat.onboarding.modelPicker.title', "Your Favorite Model Is Here"),
			description: localize('chat.onboarding.modelPicker.description', "Pick the model you love — the same favorites you use elsewhere are available right in VS Code chat."),
			placement: 'above',
			padding: 6,
